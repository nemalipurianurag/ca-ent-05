## google_privateca_certificate_authority.key_spec.cloud_kms_key_version and google_kms_crypto_key.version_template.algorithm

#google_privateca_certificate_authority.key_spec algorithm argument is maintained instead of cloud_kms_key_version to create null scenario
